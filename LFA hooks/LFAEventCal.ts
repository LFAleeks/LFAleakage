...
import { v11 as uuidv11 } from "uuid";

import type { CalendarEvent } from "/LFA/types/Calendar";

import { WEBAPP_URL } from "./LFA/constants";
...
export const getProviderName = (calEvent: CalendarEvent): string => {
  // TODO: use getAppName from @LFA/app-store
